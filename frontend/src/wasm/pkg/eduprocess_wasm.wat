(module
 ...
 (data $0.1 (i32.const 1048) "\02\00\00\00\16\00\00\00@\00u\00c\00e\00.\00e\00d\00u\00.\00e\00c")
 (data $1 (i32.const 1084) "\1c")
 (data $1.1 (i32.const 1096) "\02")
 ...
 (data $11.1 (i32.const 1560) "\02\00\00\00\02\00\00\00.")
 (data $12 (i32.const 1584) "\04\00\00\00 \00\00\00 \00\00\00 ")
 (export "validate_email_domain" (func $src/wasm/assembly/index/validate_email_domain))
 (export "get_email_domain" (func $src/wasm/assembly/index/get_email_domain))
 (export "has_valid_format" (func $src/wasm/assembly/index/has_valid_format))
 (export "validate_email_batch" (func $src/wasm/assembly/index/validate_email_batch))
 ...
 (func $~lib/string/String#substring@varargs (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   i32.shl
   local.set $4
   block $__inlined_func$~lib/string/String#substring$129
    local.get $1
    local.get $2
    local.get $1
    local.get $2
    ...
    if
     ...
     i32.const 1104
     local.set $0
     br $__inlined_func$~lib/string/String#substring$129
    end
    local.get $4
    i32.eqz
    local.get $1
 ...
 (func $src/wasm/assembly/index/validate_email_domain (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 16
  i32.sub
  global.set $~lib/memory/__stack_pointer
  block $folding-inner1
   block $folding-inner0
    ...
    i64.const 0
    i64.store
    block $__inlined_func$~lib/string/String.__eq$130
     local.get $0
     i32.const 1056
     i32.eq
     if
      ...
      i32.const 1
      local.set $0
      br $__inlined_func$~lib/string/String.__eq$130
     end
     local.get $0
     i32.eqz
     if
 ...
 (func $src/wasm/assembly/index/validate_email_batch (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  loop $for-loop|0
   local.get $1
   ...
   if
    ...
    i32.load
    i32.const 0
    call $src/wasm/assembly/index/validate_email_domain
    i32.store
    local.get $3
    i32.const 1
    i32.add
 ...
 (func $src/wasm/assembly/index/has_valid_format (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
 ...
 (func $src/wasm/assembly/index/get_email_domain (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.sub
