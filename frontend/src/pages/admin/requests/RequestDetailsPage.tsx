    ...
    return (
      <div className="flex h-screen items-center justify-center" style={{ background: tk.bg }}>
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs font-bold uppercase tracking-widest" style={{ color: tk.subtle }}>
            Loading…
          </p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen py-8 px-4 md:px-8" style={{ background: tk.bg }}>
      <div className="mx-auto max-w-3xl">
        ...
        <button
          onClick={() => navigate("/admin/requests")}
          className="mb-6 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest transition-opacity hover:opacity-60"
        ...
        >
          ...
          <div
            ...
            style={{
              background: `linear-gradient(90deg, ${tk.navy} 0%, ${tk.navyMid} 50%, ${tk.blue} 100%)`,
            }}
          />
            ...
            <div className="grid gap-8 md:grid-cols-5">
              ...
              <div className="md:col-span-3 space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-[10px] font-extrabold uppercase tracking-[.18em]" style={{ color: tk.subtle }}>
                    Student
                  </p>
                  <Field
                    icon={<User size={13} style={{ color: tk.navyMid }} />}
                    label="Full name"
                    value={fullName}
                  />
                  <Field
                    icon={<Mail size={13} style={{ color: tk.navyMid }} />}
                    label="Institutional email"
                    value={detail.student.email}
                  />
                  {detail.career && (
                    <Field
                      icon={<GraduationCap size={13} style={{ color: tk.navyMid }} />}
                      label="Program"
                      value={detail.career}
                    />
                  )}
                  {detail.semester && (
                    <Field
                      icon={<BookOpen size={13} style={{ color: tk.navyMid }} />}
                      label="Semester"
                  ...
                  {detail.reason && (
                    ...
                    >
                      <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: tk.subtle }}>
                        Reason
                      </p>
                  ...
                  {documents.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {documents.map((doc) => (
                        <div
                          key={doc.id}
                          className="group flex items-center justify-between px-3.5 py-2.5 rounded-xl transition-all hover:translate-x-0.5"
              ...
              <div className="md:col-span-2">
                <p className="text-[10px] font-extrabold uppercase tracking-[.18em] mb-4" style={{ color: tk.subtle }}>
                  Audit History
                </p>
                ...
                {history.length === 0 ? (
                  ...
                  <div className="relative pl-4" style={{ borderLeft: `2px solid ${tk.border}` }}>
                    {history.map((entry) => {
                      ...
                      return (
                        <div key={entry.id} className="relative mb-5 last:mb-0">
                          ...
                          <div className="flex items-center justify-between gap-1 mb-0.5">
                            <span className="text-[10px] font-extrabold uppercase tracking-wider" style={{ color: dot }}>
                              {entry.action}
                            </span>
                          ...
                          {entry.oldValue && entry.newValue && (
                            <p
                              className="text-[11px] mt-1 px-2 py-1 rounded-lg italic"
      ...
      {isConfirmOpen && (
        ...
        >
          ...
          >
            ...
            {comment.trim() && (
              <div
                className="p-3 rounded-xl text-xs italic mb-4"
                style={{ background: tk.bg, border: `1px solid ${tk.border}`, color: tk.inkSoft }}
              >
