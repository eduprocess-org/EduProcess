...
function DashboardEmpty() {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-100 dark:border-gray-700 bg-white dark:bg-gray-900 py-16 text-center shadow-sm dark:shadow-none">
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-slate-100 dark:bg-gray-800 text-slate-400 dark:text-slate-500">
        <FolderOpen size={26} />
      </div>
