  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="mb-5 flex items-center justify-between">
        <GraduationCap size={24} className="text-[#0B2D63]" />
      ...
      <div className="mt-auto">
        ...
        <button
          ...
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-[#0B2D63] px-4 py-3 text-sm font-medium text-white transition-all duration-300 hover:bg-[#09224E]"
        >
          View Procedure
          <ArrowRight size={16} />
        </button>
